...
Current version is 0.2.4 (Mar 21, 2026). Released for Scala 3 only.
...
```scala
//> using dep io.github.spamegg1::tarski:0.2.4
```

For SBT, add to your `build.sbt`:

```scala
libraryDependencies += "io.github.spamegg1" %% "tarski" % "0.2.4"
```
...
Just `:dep io.github.spamegg1::tarski:0.2.4` then `tarski.main.Example.runExample`.
