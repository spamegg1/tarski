...
Current version is 0.1.13 (Feb 10, 2026). Released for Scala 3 only.
...
```scala
//> using dep io.github.spamegg1::tarski:0.1.13
```

For SBT, add to your `build.sbt`:

```scala
libraryDependencies += "io.github.spamegg1" %% "tarski" % "0.1.13"
```
