...
Current version is 0.1.12 (Feb 09, 2026). Released for Scala 3 only.
...
```scala
//> using dep io.github.spamegg1::tarski:0.1.12
```

For SBT, add to your `build.sbt`:

```scala
libraryDependencies += "io.github.spamegg1" %% "tarski" % "0.1.12"
```
