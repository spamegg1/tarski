...
Current version is 0.1.5 (Dec 08, 2025). Released for Scala 3 only.
...
```scala
//> using dep io.github.spamegg1::tarski:0.1.5
```

For SBT, add to your `build.sbt`:

```scala
libraryDependencies += "io.github.spamegg1" %% "tarski" % "0.1.5"
```
