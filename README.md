...
Current version is 0.1.6 (Dec 09, 2025). Released for Scala 3 only.
...
```scala
//> using dep io.github.spamegg1::tarski:0.1.6
```

For SBT, add to your `build.sbt`:

```scala
libraryDependencies += "io.github.spamegg1" %% "tarski" % "0.1.6"
```
